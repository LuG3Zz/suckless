...
static const char *fonts[] = {
    /*"monospace:size=12",*/
    "Symbols Nerd Font:type=2048-em:pixelsize=17:antialias=true:automint=true",
...
static const Rule rules[] = {
    ...
    {"qqmusic", NULL, NULL, 0, 0, 1, -1},
    {"QQ", NULL, NULL, 0, 0, 1, -1},
...
static const Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_s, movecenter, {.ui = WIN_C}},
